...
# Spherical harmonics variation in time, Tide raised on Io
...
# Spherical harmonics variation in time, Tide raised on Jupiter
tide_raising_body = "Io"
#love_number_Jup = complex(0.379, -1.102e-5)
love_numbers_jup = dict( )
love_numbers_jup[ 2 ] = list()
love_numbers_jup[ 2 ].append(complex(0.0, 0.0))
love_numbers_jup[ 2 ].append(complex(0.0, 0.0))
love_numbers_jup[ 2 ].append(complex(0.379, -1.102e-5))
gravity_field_variation_list = list()
gravity_field_variation_list.append(environment_setup.gravity_field_variation.solid_body_tide_degree_order_variable_complex_k(
     "Io", love_numbers_jup))
...
dadt = 2/3*c*(1-7*D*(eccentricity)**2)*semi_major_axis # Planet + Satellite
