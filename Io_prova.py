...
simulation_end_epoch = 1.0e7 + 0.5 * constants.JULIAN_YEAR
...
# Librations
scaled_libration_amplitude = -26.65
...
acceleration_models = propagation_setup.create_acceleration_models(body_system, acceleration_settings, bodies_to_propagate, central_bodies)
